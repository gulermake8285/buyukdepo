...
}// ARSA Token - Complete JavaScript - FIXED VERSION
...
const translations = {
    ...
    ar: {
        ...
        // Admin Panel
        'admin.login.title': 'الوصول للإدارة',
        ...
        'admin.security.indicator': '🛡️ جلسة آمنة نشطة',
        
        'admin.panel.title': '🎛️ لوحة الإدارة',
        'admin.panel.subtitle': 'إدارة العقارات والرموز غير القابلة للاستبدال وعمليات المنصة',
        
        'admin.property.add.title': '🏢 إضافة عقار جديد',
        'admin.property.add.name': 'عنوان العقار',
        'admin.property.add.location': 'الموقع',
        'admin.property.add.value': 'إجمالي قيمة العقار (€)',
        'admin.property.add.yield': 'العائد السنوي (%)',
        'admin.property.add.nfts': 'عدد الرموز غير القابلة للاستبدال',
        'admin.property.add.description': 'وصف العقار',
        'admin.property.add.button': 'إضافة العقار',
        
        'admin.stats.title': '📊 إحصائيات المنصة',
        'admin.stats.properties': 'إجمالي العقارات',
        'admin.stats.investors': 'المستثمرون النشطون',
        'admin.stats.tvl': 'إجمالي القيمة المقفلة',
        'admin.stats.nfts': 'الرموز المباعة',
        'admin.stats.revenue': 'الإيرادات الشهرية',
        
        'admin.rental.title': '💰 توزيع الإيجار',
        'admin.rental.amount': 'مبلغ الإيجار الشهري (€)',
        'admin.rental.info.title': 'معلومات التوزيع',
        'admin.rental.info.text': 'سيتم توزيع دخل الإيجار تلقائياً على جميع حاملي الرموز بشكل متناسب بناءً على نسبة ملكيتهم.',
        'admin.rental.button': 'توزيع الإيجار',
        
        'admin.users.title': '👥 إدارة المستخدمين',
        'admin.users.recent': 'المعاملات الأخيرة',
        'admin.users.rental.received': 'تم استلام الإيجار',
        'admin.users.rental.monthly': 'التوزيع الشهري',
        
        'admin.nft.title': '🎨 إدارة الرموز غير القابلة للاستبدال',
        'admin.nft.property': 'اختيار العقار',
        'admin.nft.price': 'سعر الرمز (€)',
        'admin.nft.available': 'الرموز المتاحة',
        'admin.nft.pause': 'إيقاف المبيعات',
        'admin.nft.update': 'تحديث التسعير',
        
        'admin.settings.title': '⚙️ إعدادات النظام',
        'admin.settings.fee': 'رسوم المنصة (%)',
        'admin.settings.minimum': 'الحد الأدنى للاستثمار (€)',
        'admin.settings.token.price': 'سعر رمز ARSA (€)',
        'admin.settings.warning.title': '⚠️ مهم',
        'admin.settings.warning.text': 'التغييرات في إعدادات النظام ستؤثر على جميع المعاملات المستقبلية. يرجى التحقق قبل الحفظ.',
        'admin.settings.save': 'حفظ الإعدادات',
        
        // Property Detail Page
        'property.back': '← العودة إلى العقارات',
        'property.title': 'مجمع مكاتب وسط المدينة',
        'property.location': '📍 Potsdamer Platz 1، برلين، ألمانيا',
        'property.status.available': '🟢 متاح للاستثمار',
        'property.status.verified': '✅ عقار موثق',
        
        'property.gallery.title': 'مبنى مكاتب متميز',
        'property.gallery.subtitle': 'مساحة عمل حديثة في المنطقة المالية ببرلين',
        
        'property.details.title': '📋 معلومات العقار',
        'property.details.type': 'نوع العقار',
        'property.details.type.value': 'مبنى مكاتب تجاري',
        'property.details.area': 'إجمالي المساحة',
        'property.details.floors': 'الطوابق',
        'property.details.floors.value': '8 طوابق + موقف تحت الأرض',
        'property.details.year': 'سنة البناء',
        'property.details.year.value': '2019 (تم التجديد مؤخراً 2023)',
        'property.details.occupancy': 'معدل الإشغال',
        'property.details.occupancy.value': '92% (منطقة عالية الطلب)',
        'property.details.tenants': 'المستأجرون الحاليون',
        'property.details.tenants.value': '5 شركات (تقنية، مالية، قانونية)',
        'property.details.registry': 'تسجيل العقار',
        
        'property.legal.title': '📄 الوثائق القانونية والتحقق',
        'property.legal.deed.title': 'سند ملكية العقار (Grundbuch)',
        'property.legal.deed.desc': 'وثيقة ملكية رسمية من سجل الأراضي ببرلين',
        'property.legal.permit.title': 'رخصة البناء والامتثال',
        'property.legal.permit.desc': 'تراخيص بناء صالحة وشهادات أمان',
        'property.legal.income.title': 'سجلات دخل الإيجار',
        'property.legal.income.desc': 'تاريخ دخل الإيجار لآخر 12 شهراً',
        'property.legal.structure.title': 'الهيكل القانوني وحقوق الرموز',
        'property.legal.structure.desc': 'كيف تتحول ملكية الرموز إلى حقوق عقارية',
        'property.legal.view': 'عرض',
        
        'property.howto.title': '💡 كيف يعمل (شرح بسيط)',
        'property.howto.step1.title': '1. عقار حقيقي:',
        'property.howto.step1.text': 'هذا مبنى مكاتب حقيقي في برلين نملكه قانونياً. يمكنك زيارته، له مستأجرون حقيقيون يدفعون إيجاراً حقيقياً.',
        'property.howto.step2.title': '2. مقسم إلى 8,500 قطعة:',
        'property.howto.step2.text': 'قسمنا هذا المبنى البالغ قيمته €850,000 إلى 8,500 قطعة رقمية (رموز NFT). كل قطعة تكلف €100.',
        'property.howto.step3.title': '3. تشتري القطع:',
        'property.howto.step3.text': 'عندما تشتري رموز NFT، فأنت تملك ذلك الجزء من المبنى الحقيقي. الأمر مثل امتلاك أسهم في شركة، لكن للعقارات.',
        'property.howto.step4.title': '4. اكسب إيجاراً:',
        'property.howto.step4.text': 'كل شهر، يكسب المبنى حوالي €51,200 إيجاراً. نقسم هذا المال بين جميع مالكي الرموز بناءً على عدد القطع التي يملكونها.',
        'property.howto.step5.title': '5. حقوقك:',
        'property.howto.step5.text': 'لديك حقوق ملكية قانونية، وحقوق تصويت في القرارات المهمة، ويمكنك بيع رموزك في أي وقت.',
        
        'property.investment.title': '🏗️ فرصة استثمارية',
        'property.nft.status': 'حالة مبيعات الرموز',
        'property.nft.sold': 'مباع',
        'property.nft.available': 'متاح',
        'property.nft.progress': 'تقدم التمويل',
        'property.nft.complete': 'مكتمل',
        
        'property.trust.verified': 'العقار موثق من قبل السلطات الألمانية',
        'property.trust.legal': 'هيكل الملكية القانوني مؤسس',
        'property.trust.income': 'دخل إيجار 12 شهراً مثبت',
        'property.trust.audited': 'العقد الذكي مدقق وآمن',
        
        'property.stats.value': 'إجمالي قيمة العقار',
        'property.stats.price': 'سعر الرمز الواحد',
        'property.stats.rent': 'الإيجار الشهري (الإجمالي)',
        'property.stats.yield': 'العائد السنوي',
        'property.stats.monthly': 'الدخل الشهري لكل رمز',
        
        'property.calc.title': '💰 حاسبة الاستثمار',
        'property.calc.nfts': 'الرموز التي ستملكها:',
        'property.calc.monthly': 'الدخل الشهري:',
        'property.calc.annual': 'العائد السنوي:',
        'property.calc.total': 'إجمالي الاستثمار:',
        ...
        'dashboard.subtitle': 'تتبع استثماراتك في الرموز غير القابلة للاستبدال العقارية وأرباحك',
        'dashboard.wallet.required.title': 'مطلوب ربط المحفظة',
        'dashboard.wallet.required.text': 'يرجى ربط محفظتك لعرض محفظتك وتتبع استثماراتك في الرموز غير القابلة للاستبدال العقارية.',
        ...
        'dashboard.income.history.title': 'تاريخ الدخل الأخير',
        ...
        'dashboard.performance.placeholder': 'رسم بياني لأداء المحفظة',
        ...
        'dashboard.actions.stake.desc': 'اكسب مكافآت إضافية',
        'dashboard.actions.referral': 'ادع الأصدقاء',
        'dashboard.actions.referral.desc': 'اكسب مكافآت إضافية',

        // Properties Page Translations
        'properties.page.title': 'العقارات الاستثمارية',
        'properties.page.subtitle': 'اكتشف فرص العقارات المتميزة في أوروبا',
        'properties.page.stats.total': '24',
        'properties.page.stats.total.label': 'إجمالي العقارات',
        'properties.page.stats.available': '18',
        'properties.page.stats.available.label': 'متاح الآن',
        'properties.page.stats.value': '€45.2M',
        'properties.page.stats.value.label': 'إجمالي قيمة المحفظة',
        'properties.page.stats.yield': '7.8%',
        'properties.page.stats.yield.label': 'متوسط العائد',

        // Search and Filters
        'properties.search.placeholder': 'البحث حسب المدينة أو اسم العقار أو النوع...',
        'properties.filter.location': 'الموقع',
        'properties.filter.all.locations': 'جميع المواقع',
        'properties.filter.type': 'نوع العقار',
        'properties.filter.all.types': 'جميع الأنواع',
        'properties.filter.office': 'مكتب',
        'properties.filter.residential': 'سكني',
        'properties.filter.retail': 'تجاري',
        'properties.filter.warehouse': 'مستودع',
        'properties.filter.hotel': 'فندق',
        'properties.filter.status': 'الحالة',
        'properties.filter.all.status': 'جميع الحالات',
        'properties.filter.available': 'متاح',
        'properties.filter.selling': 'يباع بسرعة',
        'properties.filter.sold': 'نفد',
        'properties.filter.clear': 'مسح الكل',

        // Results and Sorting
        'properties.results.showing': 'يعرض',
        'properties.results.properties': 'عقار',
        'properties.sort.newest': 'الأحدث أولاً',
        'properties.sort.price.low': 'السعر: من الأقل للأعلى',
        'properties.sort.price.high': 'السعر: من الأعلى للأقل',
        'properties.sort.yield.high': 'أعلى عائد',
        'properties.sort.yield.low': 'أقل عائد',
        'properties.sort.name': 'الاسم أ-ي',

        // Property Types and Status
        'properties.type.office': 'مكتب',
        'properties.type.residential': 'سكني',
        'properties.type.retail': 'تجاري',
        'properties.type.warehouse': 'مستودع',
        'properties.type.hotel': 'فندق',
        'properties.status.available': 'متاح',
        'properties.status.selling': 'يباع بسرعة',
        'properties.status.sold': 'نفد',

        // Individual Properties
        'properties.berlin.office.title': 'مجمع مكاتب وسط المدينة',
        'properties.berlin.office.location': '📍 برلين، ألمانيا',
        'properties.amsterdam.apartment.title': 'مجمع شقق فاخرة',
        'properties.amsterdam.apartment.location': '📍 أمستردام، هولندا',
        'properties.vienna.retail.title': 'مركز تسوق تجاري',
        'properties.vienna.retail.location': '📍 فيينا، النمسا',
        'properties.hamburg.warehouse.title': 'مركز مستودعات لوجستية',
        'properties.hamburg.warehouse.location': '📍 هامبورغ، ألمانيا',
        'properties.munich.hotel.title': 'فندق أعمال ميونيخ',
        'properties.munich.hotel.location': '📍 ميونيخ، ألمانيا',
        'properties.frankfurt.office.title': 'برج المنطقة المالية',
        'properties.frankfurt.office.location': '📍 فرانكفورت، ألمانيا',
        'properties.zurich.retail.title': 'منطقة تسوق متميزة',
        'properties.zurich.retail.location': '📍 زيورخ، سويسرا',
        'properties.london.office.title': 'برج مكاتب كناري وارف',
        'properties.london.office.location': '📍 لندن، المملكة المتحدة',
        'properties.paris.apartment.title': 'مساكن باريس الفاخرة',
        'properties.paris.apartment.location': '📍 باريس، فرنسا',

        // Property Stats
        'properties.stats.value': 'إجمالي القيمة',
        'properties.stats.yield': 'العائد السنوي',
        'properties.stats.available': 'متاح',

        // Investment Summary
        'properties.summary.nft.price': 'سعر الرمز:',
        'properties.summary.monthly.income': 'الدخل الشهري/رمز:',
        'properties.summary.min.investment': 'الحد الأدنى للاستثمار:',
        'properties.summary.status': 'الحالة:',

        // Property Actions
        'properties.action.view': 'عرض التفاصيل',
        'properties.action.invest': 'استثمر الآن',
        'properties.action.sold': 'نفد',

        // Pagination
        'properties.pagination.previous': 'السابق',
        'properties.pagination.next': 'التالي',
        
        // Home page properties section
        'properties.view.all': '🏢 عرض جميع العقارات (24 متاح)',
        'properties.view.all.subtitle': 'استكشف محفظتنا الكاملة من الاستثمارات العقارية المتميزة'
    }
};
...
const translations = {
  en: {
    ...
    "nav.connect": "Connect Wallet",
    "hero.title": "Invest in Real Estate<br>Through NFTs",
    "hero.subtitle": "Democratizing real estate investment through blockchain technology.",
    "hero.start": "Start Investing",
    "hero.learn": "Learn More",
    "features.title": "Why Choose ARSA Token?",
    "features.subtitle": "Experience the future of real estate investment",
  ...
  tr: {
    ...
    "hero.title": "NFT'ler Üzerinden<br>Gayrimenkule Yatırım Yap",
    "hero.subtitle": "Blockchain teknolojisi ile gayrimenkul yatırımını demokratikleştiriyoruz.",
    "hero.start": "Yatırıma Başla",
    "hero.learn": "Daha Fazla Bilgi",
    "features.title": "Neden ARSA Token?",
    "features.subtitle": "Gayrimenkul yatırımının geleceği",
    "footer.follow": "ARSA Token'ı Takip Et",
  }
};

document.getElementById('languageSelect')?.addEventListener('change', function () {
  const lang = this.value;
  const items = document.querySelectorAll('[data-translate]');
  items.forEach(el => {
