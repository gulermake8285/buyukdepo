// ARSA Token - Complete JavaScript - UPDATED VERSION (LOGO ADMIN ACCESS REMOVED)
...
function checkLoginStatus() {
    const isLoggedIn = safeLocalStorage('get', 'isLoggedIn') === 'true';
    const userRole = safeLocalStorage('get', 'userRole');
...
function logout() {
    ...
    safeLocalStorage('remove', 'isLoggedIn');
    safeLocalStorage('remove', 'userEmail');
    safeLocalStorage('remove', 'userId');
    safeLocalStorage('remove', 'userRole');
    ...
    showNotification(logoutTexts[currentLanguage] || logoutTexts.en, 'success');
...
// MAIN INITIALIZATION FUNCTION - IMPROVED (LOGO ADMIN ACCESS REMOVED)
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('🔴 Logo admin access has been removed for security');
});
